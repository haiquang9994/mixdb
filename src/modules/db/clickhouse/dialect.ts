 ...
 * only DDL and dump/restore (`writable`) are still closed, see
...
export const clickhouseDialect: SqlDialect = {
  ...
  cancellable: false,
  // The Query tab's DDL and dump/restore are still closed — see `SqlDialect.writable`. Its four
  // DML verbs are open through `rowsWritable` instead, see
  // `docs/superpowers/specs/2026-09-04-clickhouse-query-dml-design.md`.
  writable: false,
